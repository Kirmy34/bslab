...
public:
    ...
    virtual int readFat();
    virtual int writeFat();
    virtual int readBlt();
    virtual int writeBlt();
    virtual int getFileIndex(const char *path);
    virtual int findFreeBlock(unsigned short &freeBlock);
};
